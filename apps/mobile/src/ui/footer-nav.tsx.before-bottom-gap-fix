...
export const FOOTER_NAV_RESERVED_SPACE = 84;
      ...
      <View style={[styles.host, { paddingBottom: Math.max(insets.bottom, 2) }]}>
        <View style={styles.shell} onLayout={handleLayout}>
          ...
          <View style={styles.row}>
            <FooterButton Icon={AirdropIcon} label="AIRDROP" onPress={() => router.push('/airdrop' as any)} />
            <FooterButton Icon={BuyIcon} label="BUY" onPress={() => router.push('/buy' as any)} />
            ...
            <FooterButton Icon={SwapIcon} label="SWAP" onPress={() => router.push('/swap' as any)} />
            <FooterButton Icon={AmbassadorIcon} label="AMBASSADOR" onPress={() => router.push('/ambassador' as any)} />
          </View>
        </View>
      </View>
    </View>
