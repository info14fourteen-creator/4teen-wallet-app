...
import ScreenBrow from '../../ui/screen-brow';
import ScreenLoadingOverlay from '../../ui/screen-loading-overlay';
import ScreenLoadingState from '../../ui/screen-loading-state';
import SunioDisclosureCard from '../../ui/sunio-disclosure-card';
import ApprovalAuthModal from '../../ui/approval-auth-modal';
import EnergyResaleCard from '../../ui/energy-resale-card';
import ConfirmNetworkLoadCard from '../../ui/confirm-network-load-card';
import { useNavigationInsets } from '../../ui/navigation';
import { useBottomInset } from '../../ui/use-bottom-inset';
import useChromeLoading from '../../ui/use-chrome-loading';
import { goBackOrReplace } from '../../ui/safe-back';
...
} from '../../services/swap/draft';
import {
  buildSwapReview,
  executeSwap,
  type FourteenSwapReview,
} from '../../services/swap/sunio';
import {
  getBiometricsEnabled,
  verifyPasscode,
} from '../../security/local-auth';
import { useWalletSession } from '../../wallet/wallet-session';
import {
  getEnergyResaleQuote,
  rentEnergyForPurpose,
  type EnergyResaleQuote,
} from '../../services/energy-resale';
import {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['left', 'right']}>
      <View style={styles.screen}>
        ...
        >
          <ScreenBrow label={t('Swap via SUN.io')} variant="back" />
            ...
            <>
              ...
              <View style={styles.sectionBlock}>
                ...
                <View style={styles.detailCard}>
                  ...
                  <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>{t('PRICE IMPACT')}</Text>
                    <Text style={styles.detailValue}>{review.route.impactLabel}</Text>
                  </View>
        ...
        <ApprovalAuthModal
          ...
          eyebrow={t('Swap via SUN.io')}
          actionLabel={pendingApprovalMode === 'rent' ? t('Energy rental and swap') : t('Sign transaction')}
